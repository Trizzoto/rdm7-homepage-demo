...
function findWasmBinary() {
  return locateFile('rdm7-sandbox-round.wasm');
}
...
var _sandbox_close_widget_config = Module['_sandbox_close_widget_config'] = makeInvalidEarlyAccess('_sandbox_close_widget_config');
var _sandbox_open_wifi_settings = Module['_sandbox_open_wifi_settings'] = makeInvalidEarlyAccess('_sandbox_open_wifi_settings');
var _sandbox_open_peaks = Module['_sandbox_open_peaks'] = makeInvalidEarlyAccess('_sandbox_open_peaks');
var _sandbox_open_diagnostics = Module['_sandbox_open_diagnostics'] = makeInvalidEarlyAccess('_sandbox_open_diagnostics');
var _sandbox_open_dimmer_config = Module['_sandbox_open_dimmer_config'] = makeInvalidEarlyAccess('_sandbox_open_dimmer_config');
var _sandbox_open_bus_scan = Module['_sandbox_open_bus_scan'] = makeInvalidEarlyAccess('_sandbox_open_bus_scan');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['sandbox_step'] != 'undefined', 'missing Wasm export: sandbox_step');
  assert(typeof wasmExports['sandbox_set_pointer'] != 'undefined', 'missing Wasm export: sandbox_set_pointer');
  ...
  assert(typeof wasmExports['sandbox_close_widget_config'] != 'undefined', 'missing Wasm export: sandbox_close_widget_config');
  assert(typeof wasmExports['sandbox_open_wifi_settings'] != 'undefined', 'missing Wasm export: sandbox_open_wifi_settings');
  assert(typeof wasmExports['sandbox_open_peaks'] != 'undefined', 'missing Wasm export: sandbox_open_peaks');
  assert(typeof wasmExports['sandbox_open_diagnostics'] != 'undefined', 'missing Wasm export: sandbox_open_diagnostics');
  assert(typeof wasmExports['sandbox_open_dimmer_config'] != 'undefined', 'missing Wasm export: sandbox_open_dimmer_config');
  assert(typeof wasmExports['sandbox_open_bus_scan'] != 'undefined', 'missing Wasm export: sandbox_open_bus_scan');
  ...
  _sandbox_step = Module['_sandbox_step'] = createExportWrapper('sandbox_step', 0);
  _sandbox_set_pointer = Module['_sandbox_set_pointer'] = createExportWrapper('sandbox_set_pointer', 3);
  ...
  _sandbox_close_widget_config = Module['_sandbox_close_widget_config'] = createExportWrapper('sandbox_close_widget_config', 0);
  _sandbox_open_wifi_settings = Module['_sandbox_open_wifi_settings'] = createExportWrapper('sandbox_open_wifi_settings', 0);
  _sandbox_open_peaks = Module['_sandbox_open_peaks'] = createExportWrapper('sandbox_open_peaks', 0);
  _sandbox_open_diagnostics = Module['_sandbox_open_diagnostics'] = createExportWrapper('sandbox_open_diagnostics', 0);
  _sandbox_open_dimmer_config = Module['_sandbox_open_dimmer_config'] = createExportWrapper('sandbox_open_dimmer_config', 0);
  _sandbox_open_bus_scan = Module['_sandbox_open_bus_scan'] = createExportWrapper('sandbox_open_bus_scan', 0);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = RDM7Sandbox;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = RDM7Sandbox;
